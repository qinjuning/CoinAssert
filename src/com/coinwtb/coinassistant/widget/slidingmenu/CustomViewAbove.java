package com.coinwtb.coinassistant.widget.slidingmenu;
...
import com.coinwtb.coinassistant.widget.slidingmenu.SlidingMenu.OnClosedListener;
import com.coinwtb.coinassistant.widget.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	void smoothScrollTo(int x, int y, int velocity) {
		...
		Log.e("qinjun", "duration 11:: " + duration);
		duration = Math.min(duration, MAX_SETTLE_DURATION);

		Log.e("qinjun", "duration 22:: " + duration);
		
		duration = Math.abs(dx) * 5;
		
		Log.e("qinjun", "duration 33:: " + duration);
		
		mScroller.startScroll(sx, sy, dx, dy, 400);
		invalidate();
	}
